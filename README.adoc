...
Technical design docs are link:gdd/[here]
...
=== v0.0.2-prototype_1 Groundwork for Basic Map and Level Object System
...
* [ ] Implement groundwork for level object interaction system
* [ ] Design player control input handling via the creature control system
* [ ] Have an enemy critter on the test map, a static dummy (for now)
